        ...
        <div className='header-btn header-dropdown-btn'
          ...
          <div className='header-dropdown-menu header-dropdown-menu-docs'>
            <div className='header-dropdown-inner-btn'>
              <a href='https://algrx.github.io/algorithmx/docs/js/' target='_blank' className='a-btn'>
                <span className='fab fa-js header-dropdown-inner-icon'/>
                JavaScript
              </a>
            </div>
            <div className='header-dropdown-inner-btn'>
              <a href='https://algrx.github.io/algorithmx/docs/python' target='_blank' className='a-btn'>
...
export const HeaderConnected = connect<{}, HeaderDispatchProps, HeaderOwnProps, RootState>(
  () => ({}),
  dispatch => ({
    dispatchToggleDropdown: (section, open) => dispatch<ActionToggleDropdown>(
      { type: HeaderActionType.ToggleDropdown, section, open })
  })
)(Header)
